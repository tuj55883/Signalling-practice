...
//gcc -g -Wall -pthread signalPractice.c -lpthread -o signalPractice
//TODO:
//Results write up
//Clean up the description write up
...
int main(int argc, char *argv[])
{
    ...
    if (argv[1] == NULL)
    {
        ...
        printf("Type \"./signalPractice 1\" for 10000 signals or \"./signalPractice 2\" for 30 seconds\n");
        exit(1);
    }
...
void report_thread()
{
    ...
    while (1)
    {
        ...
        {//If it has then we will make a log entry for the 16 signals
            ...
            fp = fopen("signalPractice_thread_log.txt", "a+");
...
void sig_generator(int send1, int send2)
{
    ...
    while (1)
    {
        ...
        if (choice == 1)
        {
            ...
            fp = fopen("signalPractice_sender_log.txt", "a");
